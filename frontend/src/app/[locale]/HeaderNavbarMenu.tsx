...
export default function HeaderNavbarMenu({ messages, locale }: Props) {
  ...
  if (Config.isDemoSite) {
    commonLinks.push(
      {
        uid: 'docs',
        href: 'https://lbltnmrgnv.github.io/testtcms/docs/getstarted/selfhost',
        label: messages.docs,
        isExternal: true,
      },
      {
        uid: 'roadmap',
        href: 'https://lbltnmrgnv.github.io/testtcms/docs/roadmap/',
      ...
      <NavbarContent className="basis-1/5 sm:basis-full" justify="start">
        <NavbarBrand as="li" className="gap-3 max-w-fit">
          <Link className="flex justify-start items-center gap-1" href="/" locale={locale}>
            ...
            <p className="font-bold text-inherit ms-1">TestTMS</p>
          </Link>
        </NavbarBrand>
